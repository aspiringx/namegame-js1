...
export function restRoutes(app: Koa): void {
    ...
    router.post('/user/greet', async (ctx: Context) => {
    ...
    router.delete('/group/:groupId/user/:userId', async (ctx: Context) => {
